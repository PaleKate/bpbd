			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="pull-right">
					...
					<ul class="dropdown-menu pull-right">
						<li><a href="pages/profil/profil.php?id=<?php echo $results['id_administrator']; ?>"><i class="material-icons">person</i>Profil</a></li>
						<li><a href="pages/profil/password.php?id=<?php echo $results['id_administrator']; ?>"><i class="material-icons">vpn_key</i>Password</a></li>

            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Data Jabatan di BPBD Kota Tasikmalaya
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
								...
								<table class="display table table-striped table-bordered table-hover" width="100%" id="example-table" cellspacing="0">
									...
									<tbody>
										<?php 
											$nomor=0;
											$sqlkat = "SELECT * FROM jabatan ORDER BY nomor ASC";
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn btn-warning btn-circle waves-effect waves-circle waves-float" 
														data-toggle="modal" data-target="#editModal<?php echo htmlentities($result['id_jabatan']);?>">
													<i class="material-icons">mode_edit</i>
												</button>&nbsp;&nbsp;
												<!-- Large Size -->
												<div class="modal fade" id="editModal<?php echo htmlentities($result['id_jabatan']);?>" tabindex="-1" role="dialog">
													<div class="modal-dialog modal-lg" role="document">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title" id="editModalLabel">Form Edit Data Jabatan</h4>
															</div>
															<div class="modal-body">
																<form method="POST" action="module=jabatan-edit">
																	<div class="form-group">
																		<label class="form-control-label" style="float:left;">
																			<b>Jabatan</b><span style="color:red">*</span>
																		</label>
																		<div class="form-line">
																			<input type="hidden" name="id" 
																				value="<?php echo htmlentities($result['id_jabatan']);?>">
																			<input type="text" name="jabatan" class="form-control"
																				value="<?php echo htmlentities($result['jabatan']);?>" required>
																		</div>
																	</div>
															</div>
												...
												<button type="button" class="btn btn-danger btn-circle waves-effect waves-circle waves-float"
														onclick="Swal.fire({
															...
															confirmButtonText: 'Ya Hapus',
																...
																window.location = 'jabatan-del.php?id=<?php echo htmlentities($result['id_jabatan']);?>';
																}
															})">
							...
							<div class="modal fade" id="inputModal" tabindex="-1" role="dialog">
								<div class="modal-dialog modal-lg" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="inputModalLabel">Form Input Data Jabatan</h4>
										</div>
										<div class="modal-body">
											<form method="POST" action="module=jabatan-input">
												<div class="form-group">
													<label class="form-control-label"><b>Nama Jabatan</b><span style="color:red">*</span></label>
													<div class="form-line">
	...
	<script type="text/javascript">
        function deleteall() {
			...
			confirmButtonText: 'Ya Hapus',
				...
				if (result.isConfirmed) {
				window.location = 'jabatan-delall.php';
				}
			})
		}
	</script>

                        ...
                        <div class="body">
													...
													<div class="modal-dialog modal-lg" role="document">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title" id="editModalLabel">Form Edit Data Tahun</h4>
															</div>
															<div class="modal-body">
																<form method="POST" action="module=tahun-edit">
							...
							<div class="modal fade" id="inputModal" tabindex="-1" role="dialog">
								<div class="modal-dialog modal-lg" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="inputModalLabel">Form Input Data Tahun</h4>
										</div>
										<div class="modal-body">
											<form method="POST" action="module=tahun-input">
												<div class="form-group">
													<label class="form-control-label"><b>Tahun</b><span style="color:red">*</span></label>
													<div class="form-line">
														<input type="number" name="tahun" class="form-control" min=0 value="0" required>
													</div>
												</div>
										</div>
										<div class="modal-footer">

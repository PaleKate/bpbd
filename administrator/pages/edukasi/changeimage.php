            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Edit Thumbnail Konten Video BPBD Kota Tasikmalaya
                            </h2>
                        ...
                        <div class="body">
							<form method="post" class="form-horizontal" enctype="multipart/form-data">
								...
								<label class="col-sm-4 control-label">Foto Sekarang</label>
									...
									?>
									<div class="col-sm-8">
										<img src="../../images/thumbnail/<?php echo htmlentities($result['thumbnail']);?>" width="300" height="200" style="border:solid 1px #000">
									</div>
								<?php }?>
								</div>
...
if(isset($_POST['update'])){
	...
	$id=$_POST['id'];
	move_uploaded_file($_FILES["foto"]["tmp_name"],"../../images/thumbnail/".$_FILES["foto"]["name"]);
	$sql="update konten set thumbnail='$foto' where id_konten='$id'";
	$query	= mysqli_query($koneksidb, $sql);
	if($query){

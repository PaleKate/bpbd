            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Edit Gambar Pejabat BPBD Kota Tasikmalaya
                            </h2>
                        ...
                        <div class="body">
							<form method="post" class="form-horizontal" enctype="multipart/form-data">
								...
								<label class="col-sm-4 control-label">Foto Sekarang</label>
									<?php 
									$id=$_GET['imgid'];
									$sql ="SELECT * FROM pejabat WHERE id_pejabat='$id'";
									$query	= mysqli_query($koneksidb, $sql);
									$cnt=1;
									while ($result = mysqli_fetch_array($query)){
									?>
									<div class="col-sm-8">
										<img src="../../images/profil/<?php echo htmlentities($result['foto']);?>" width="300" height="200" style="border:solid 1px #000">
									</div>
								<?php }?>
								</div>
...
if(isset($_POST['update'])){
	...
	$sql="update pejabat set foto='$foto' where id_pejabat='$id'";
	$query	= mysqli_query($koneksidb, $sql);
	if($query){
